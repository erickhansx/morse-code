...
**[MORSE-CODE]** is a project built with Ruby programming language in which you will be able to decode a morse code message.
...
- **[Decode a word morse code into an English text]**
